...
class BookingsControllerTest < ActionController::TestCase
  ...
  test "should get own_bookings_index" do
    ...
    assert_not_nil assigns(:own_bookings)
    assert_not_nil assigns(:date)
    assert_not_nil assigns(:status)
    assert_template :index_own
  end
  ...
  test "should create booking" do
      post :create,  resource_id: '1', from: '2015-05-01 10:00:00', to: '2015-05-01 11:00:00', user: users(:one).id
      assert_redirected_to resource_bookings_path
      assert_not_nil assigns(:resource)
  ...
  test "should not create booking" do
      post :create, resource_id: '1', from: '2015-01-01 10:00', to: '2015-01-01 11:00', user: users(:one).id
      assert_redirected_to resource_bookings_path
      assert_not_nil assigns(:resource)
      assert_not_nil assigns(:booking)
    ...
    test "should not create booking2" do
      post :create, resource_id: '1', user: users(:one).id
      assert_redirected_to resource_bookings_path
      assert_not_nil assigns(:resource)
      assert_not_nil assigns(:booking)
      assert_not_nil flash[:error]
